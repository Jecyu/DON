 ...
 * @Modified By: JeCyu
 * @Last Modified time: 2017-12-17 1:49:28 pm
 */
/**

/*!
 * gulp
 * $ npm install gulp gulp-ruby-sass gulp-cached gulp-uglify gulp-rename gulp-concat gulp-notify gulp-filter gulp-jshint gulp-rev-append gulp-cssnano gulp-imagemin browser-sync gulp-file-include gulp-autoprefixer del gulp-babel  babel-preset-env --save-dev
 */
...
var gulp = require("gulp"), // 必须先引入gulp插件
    ...
    babel = require("gulp-babel"), // 引入babel编译器
...
// build，关连执行全部编译任务
gulp.task("build", ["sass", "css", "script", "image", "fonts"], function() {
    gulp.start("html");
});
